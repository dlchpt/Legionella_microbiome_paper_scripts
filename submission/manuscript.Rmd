...
# City * CFU, blocked with Bldg_loc_ID (betta_random can't take two grouping variables, it)
betta_blocked <- betta_random(formula = estimate ~ City * CFU_pres_abs + (1 | Bldg_loc_ID), ses = error, data = br_V4_filt)
