...
# Note: The phyloseq object needed for this script, called  ps_object_after_dada2.rds,
# is generated by 01_DADA2_16S.R, but it can also be downloaded from 
# https://doi.org/10.6084/m9.figshare.20685301.v1 and placed in the folder /data/process/.
